...
const headers = [
	...
	{ path: demoPagesMenu.equipas.path, element: <DashboardHeader /> },
	{ path: demoPagesMenu.pricingTable.path, element: <DashboardHeader /> },
	{path: demoPagesMenu.projetos.path, element: <DashboardBookingHeader />},
	{path: 'projetos/insignias/[codigoProjeto]/[codigoInsignia]', element: <DashboardBookingHeader />},
	{path: 'projetos/trabalhos/[id]', element: <DashboardBookingHeader />},
	{path: 'dicionario', element: <DashboardBookingHeader />},
	{path: 'fotosProj', element: <DashboardBookingHeader />},
	{path: 'fotosProj/fotos/[codigoProjeto]/[codigoInsignia]', element: <DashboardBookingHeader />},
	{path: 'appointment/employee', element: <DashboardBookingHeader />},
	{path: 'adicionarColaboradores', element: <DashboardBookingHeader />},
	{path: 'colaboradores', element: <DashboardBookingHeader />},
	{path: 'fotosProj/fotosDocumentacao/[id]', element: <DashboardBookingHeader />},
